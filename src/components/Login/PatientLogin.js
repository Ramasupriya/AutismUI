...
const PatientLogin = () => {
  ...
  const handleLogin = () => {
    // if (email && password) {
      navigate('/patient'); // Navigate on successful login
    // } 
  ...
  // Signup Handler
  const handleSignup = () => {
    navigate('/signUpPage'); // Replace with your Signup page route
  };

  // Forget Password Handler
  const handleForgetPassword = () => {
    navigate('/forget-password'); // Replace with your Forget Password page route
  };
